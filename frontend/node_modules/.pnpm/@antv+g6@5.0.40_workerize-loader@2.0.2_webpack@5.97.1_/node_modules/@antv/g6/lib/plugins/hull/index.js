...
const hull_js_1 = __importDefault(require("hull.js"));
...
class Hull extends base_plugin_1.BasePlugin {
    constructor(context, options) {
        ...
        this.getHullPath = (forceUpdate = false) => {
            ...
            const vertices = (0, hull_js_1.default)(data.map(position_1.positionOf), this.options.concavity).slice(1).reverse();
