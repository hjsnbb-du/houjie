...
exports.Dendrogram = (0, react_1.forwardRef)(({ children, ...props }, ref) => {
    const options = (0, react_1.useMemo)(() => {
        const { data, defaultExpandLevel, direction = 'horizontal', compact = false, ...restProps } = props;
        return (0, options_1.mergeOptions)(constants_1.COMMON_OPTIONS, options_2.DEFAULT_OPTIONS, { data: (0, data_1.formatTreeData)(data, defaultExpandLevel) }, (0, options_2.getDendrogramOptions)({ direction, compact }), restProps);
    }, [props]);
