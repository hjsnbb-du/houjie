...
exports.Fishbone = (0, react_1.forwardRef)(({ children, ...props }, ref) => {
    const { data, defaultExpandLevel, type = 'cause', labelField, ...restProps } = props;
    const options = (0, react_1.useMemo)(() => (0, options_1.mergeOptions)(constants_1.COMMON_OPTIONS, options_2.DEFAULT_OPTIONS, { data: (0, data_1.formatTreeData)(data) }, (0, options_2.getFishboneOptions)({ type, labelField }), restProps), [props]);
